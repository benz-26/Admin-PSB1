    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?php echo base_url() ?>PSB/index2" class="nav-link">HOME</a>
        </li>
      </ul>
    </nav>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-5 rounded">
      <div class="sidebar">
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">HALLO PESERTA!</a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              <a href="<?php echo base_url() ?>PSB/account" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url() ?>PSB/registrasip" class="nav-link">
