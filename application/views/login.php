...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">LOG IN <br>PENERIMAAN SISWA BARU</p>
      <form action="<?php echo base_url()?>PSB/do_login" method="post">
        ...
        <div class="row">
          <div class="col-8">
        <a href="<?php echo base_url()?>PSB/register" class="text-center">REGISTER A NEW ACCOUNT</a>
